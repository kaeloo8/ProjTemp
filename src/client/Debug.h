...
public:
	...
	static void DrawTextDE(float x, float y, const std::string& text, const sf::Color& color);
	static void DrawTextDE(float x, float y, const std::string& text, float ratioX, float ratioY, const sf::Color& color);
