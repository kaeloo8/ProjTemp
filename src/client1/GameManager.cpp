...
void GameManager::CreateWindowGM(unsigned int width, unsigned int height, const char* title, int fpsLimit)
{
...
void GameManager::Run()
{
	if (mpWindow == nullptr) 
	{
		...
		CreateWindowGM(1280, 720, "Default window");
	}

	//#TODO : Load somewhere else
	bool fontLoaded = mFont.loadFromFile("../../src/client1/Hack-Regular.ttf");
	_ASSERT(fontLoaded);
