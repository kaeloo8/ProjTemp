...
void Debug::DrawTextDE(float x, float y, const std::string& text, const sf::Color& color)
{
	DrawTextDE(x, y, text, 0.f, 0.f, color);
}

void Debug::DrawTextDE(float x, float y, const std::string& text, float ratioX, float ratioY, const sf::Color& color)
{
